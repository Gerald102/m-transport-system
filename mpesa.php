...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" ">
  ...
  <?php
              ...
              $sql2 = "SELECT *FROM tbl_book ";//display the last book first
              //excute the query
              ...
              if ($count>0)
              {
                ...
                while ($row = mysqli_fetch_assoc($res2))
                {
                  ...
                  $total = $row['total'];}}
                  ?>
  <body oncontextmenu="return false" class="snippet-body" style='background-image: url("./images/mpesa2.jpg"); background-size: auto;'>
        ...
        <div class="media mt-3 pl-2">
            ...
            <form class="row g-3" action="./stk_initiate.php" method="POST">
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" name="amount" value="<?php echo $total; ?>" readonly>
                </div>
                <div class="col-12">
